 ...
 *    }
 */
class RabbitMQMessageQueue extends pip_services3_messaging_nodex_1.MessageQueue {
    /**
    ...
    checkOpened(correlationId) {
        if (this._mqChanel == null)
            throw new pip_services3_commons_nodex_2.InvalidStateException(correlationId, "NOT_OPENED", "The queue is not opened");
    }
    /**
    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._queue == "" && this._exchange == "") {
                throw new pip_services3_commons_nodex_1.ConfigException(correlationId, "NO_QUEUE", "Queue or exchange are not defined in connection parameters");
            }
    ...
    toMessage(msg) {
        if (msg == null)
            return null;
        let message = new pip_services3_messaging_nodex_3.MessageEnvelope(msg.properties.correlationId, msg.properties.type, msg.content.toString());
